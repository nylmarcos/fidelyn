                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('company.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" autocomplete="off" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" class="form-control price-price @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" autocomplete="off" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="points" type="number" class="form-control price-price @error('points') is-invalid @enderror" name="points" value="{{ old('points') }}" autocomplete="off" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="months_point_expiration" type="number" class="form-control price-price @error('months_point_expiration') is-invalid @enderror" name="months_point_expiration" value="{{ old('months_point_expiration') }}" autocomplete="off" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="information" name="information" rows="3" cols="44" class="form-control">
                                </textarea>
                                @error('information')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
